      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-white/10 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 text-white rounded-lg z-99999 hover:bg-white/10 lg:hidden border border-white/40 transition-colors"
          >
            <svg
              width="24"
              height="24"
            ...
            <form>
              <div className="relative">
                ...
                <Input
                  ...
                  className="h-11 w-full rounded-lg border border-white/60 bg-white py-2.5 pl-12 pr-14 text-sm text-[#134B73] placeholder:text-[#134B73]/70 shadow-sm focus:border-white focus:ring-2 focus:ring-white/70 transition-colors xl:w-[430px]"
                />
              </div>
            </form>
          </div>
