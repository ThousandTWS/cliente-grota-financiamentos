...
const useStyles = createStyles(({ css }) => {
  return {
    buttonPrimary: css({
      backgroundColor: '#134B73 !important',
      ...
      '&:hover': {
        backgroundColor: '#0f3d5f !important',
        color: '#ffffff !important',
        boxShadow:
    ...
    buttonDefault: css({
      backgroundColor: '#134B73 !important',
      color: '#ffffff !important',
      border: '1px solid #134B73 !important',
      fontWeight: '500 !important',
      textTransform: 'uppercase',
      letterSpacing: '0.02857em',
      boxShadow:
      ...
      button: {
        classNames: ({ props }) => ({
          root: clsx(
            ...
            (!props.type || props.type === 'default') && styles.buttonDefault,
