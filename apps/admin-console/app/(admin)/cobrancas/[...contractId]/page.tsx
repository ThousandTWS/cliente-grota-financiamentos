                              ...
                              <div className="flex flex-wrap items-center gap-2">
                                ...
                                {contract.customer.phone && (
                                  <a
                                    ...
                                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-[#25D366] hover:bg-[#20BA5A] text-white text-sm font-medium transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.98]"
                                  >
                                    <svg
                                      width="16"
                                      height="16"
