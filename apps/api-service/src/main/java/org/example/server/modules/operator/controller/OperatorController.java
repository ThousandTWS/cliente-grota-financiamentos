...
public class OperatorController {
        ...
        @PostMapping
        @Operation(summary = "Cadastrar operador", description = "Cadastra um operador no banco de dados")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "201", description = "Operador cadastrado com sucesso"),
                        @ApiResponse(responseCode = "400", description = "Dados inválidos"),
                        @ApiResponse(responseCode = "500", description = "Erro interno no servidor")
        })
        public ResponseEntity<OperatorResponseDTO> create(@AuthenticationPrincipal User user,
        ...
        @GetMapping
        @Operation(summary = "Listar Operadores", description = "Retorna uma lista de Operadores, ordenada por nome (10 por página)")
        @ApiResponses(value = {
        ...
        @GetMapping("/{id}")
        @Operation(summary = "Obter Operador por ID", description = "Retorna os dados de um operador com base no ID informado.")
        @ApiResponses(value = {
        ...
        @DeleteMapping("/{id}")
        @Operation(summary = "Remover operador", description = "Remove definitivamente um operador e seu usuário associado.")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Reatribuir operador para outra loja", description = "Atualiza o dealer associado ao operador.")
        @ApiResponses(value = {
        ...
        @PutMapping("/{id}")
        @Operation(summary = "Atualizar Operador por ID", description = "Atualiza os dados de um operador com base no ID informado.")
        @ApiResponses(value = {
