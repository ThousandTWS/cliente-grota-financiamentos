...
import com.grota.backend.security.oauth2.AudienceValidator;
...
@ConditionalOnProperty(prefix = "spring.security.oauth2.client.registration.oidc", name = "client-id")
@ConditionalOnProperty(prefix = "spring.security.oauth2.client.provider.oidc", name = "issuer-uri")
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        http
            ...
            .authorizeExchange(authz ->
                // prettier-ignore
                authz
                    .pathMatchers("/api/v1/grota-financiamentos/auth/register").permitAll()
