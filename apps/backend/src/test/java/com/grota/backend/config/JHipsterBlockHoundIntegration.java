...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.grota.backend.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.grota.backend.security.DomainUserDetailsService", "createSpringSecurityUser");
