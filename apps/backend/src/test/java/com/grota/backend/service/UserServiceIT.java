...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the com.grota.backend.repository.search test package.
     *
     * @see com.grota.backend.repository.search.UserSearchRepositoryMockConfiguration
     */
    @MockitoSpyBean
